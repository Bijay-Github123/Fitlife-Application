...
fun MainScreen(mainNavController: NavController) {
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable(BottomNavItem.Workouts.route) { WorkoutsScreen(navController) }
            composable(BottomNavItem.Create.route) { CreateWorkoutScreen(navController = navController) }
            composable(BottomNavItem.Delegate.route) { DelegateScreen(navController = navController) }
